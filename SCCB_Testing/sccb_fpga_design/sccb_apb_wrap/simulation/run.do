...
quietly set PROJECT_DIR "C:/Users/cheec/Desktop/Master/RISC-V_FreeRTOS_Computer_Vision/SCCB_Testing/sccb_fpga_design/sccb_apb_wrap"
...
vlog "+incdir+${PROJECT_DIR}/stimulus" -sv -work presynth "${PROJECT_DIR}/stimulus/testbench_apb.v"

vsim -L IGLOO2 -L presynth  -t 1fs presynth.testbench_apb
add wave /testbench_apb/*
run 500ns
