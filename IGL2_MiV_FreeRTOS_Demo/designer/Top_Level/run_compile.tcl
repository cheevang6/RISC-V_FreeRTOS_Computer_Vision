...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\cheec\Desktop\Master\IGL2_MiV_FreeRTOS_Demo\component\work\BasicIO_Interface\BasicIO_Interface_syn.v"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\cheec\Desktop\Master\IGL2_MiV_FreeRTOS_Demo\synthesis\Top_Level.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\cheec\Desktop\Master\IGL2_MiV_FreeRTOS_Demo\designer\Top_Level} \
    -design Top_Level \
    -fam IGLOO2 \
    -die PA4MGL2500_N \
    -pkg vf256 \
