...
#define MMIO_CLK_FREQ                   50000000UL
 ...
 */
#define IRQ30_PB1		  				External_31_IRQn
#define IRQ29_PB2 						External_30_IRQn
#define IRQ28_TIMER0	 				External_29_IRQn


/****************************************************************************
 * Baud value to achieve a 115200 baud rate with a 133MHz system clock.
 * This value is calculated using the following equation:
 *      BAUD_VALUE = (CLOCK / (16 * BAUD_RATE)) - 1
 *****************************************************************************/
#define BAUD_VALUE_115200   	(MMIO_CLK_FREQ / (16 * 115200)) - 1
 ...
 */
#define MSCC_STDIO_UART_BASE_ADDR 			BASIC_IO_INTR_ADDR
